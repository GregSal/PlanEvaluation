...
class ReportElement():
    ...
    def get_value(self, reference: PlanReference, conversion: ConversionParameters):
...
class Report():
    ...
    def __init__(self, report_def: ET.Element,
        ...
        for element in element_list.findall('ReportItem'):
            if element is not None:
                ...
                reference_name = self.add_reference(reference, alias_reference, element_name)
    ...
    def update_match(self, plan: Plan)->Tuple[MatchList, MatchList]:
