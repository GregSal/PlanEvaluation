...
class DirGuiSubFrame(tk.LabelFrame):
...
class DirGuiFrame(tk.Frame): # pylint: disable=too-many-ancestors
    ...
    def build(self, run_cmd=None):
        ...
        This method is to be overwritten for each sub-class.
        '''
        empty_label = DirGuiSubFrame(self, 'Your text goes here')
...
class FileSelectGui(DirGuiSubFrame):
